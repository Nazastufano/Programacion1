...
begin
      ...
      if (numero1> numero2) and (numero1>numero3) then
            writeln('El primer numero ingresado, el ', numero1, ', es el mayor')
      else
            if (numero1<numero2) or (numero1<numero3) then
               if numero2>numero3 then
                  writeln('El segundo numero, el numero ', numero2 ,', es el mayor')
               else
                  writeln('El tercer numero, el numero ', numero3 ,', es el mayor')
            else
