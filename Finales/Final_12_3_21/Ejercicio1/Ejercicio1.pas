...
procedure actualizarDatos(var acumImporteTotal, mayorConsumo:Real; var cantClientes:byte; RVe:TRegVer; var codCarMasConsum:ST3; importe:real);
var 
    importeTotal:Real;
begin
    cantClientes := cantClientes+1;

    if (RVe.codCarSum >= 'C01') and (RVe.codCarSum <= 'C50')  then
        importeTotal:=80000
    else
        importeTotal:=50000;
    ...
    if (RVe.gastosConsumo>mayorConsumo) and (RVe.codCarSum >= 'C01') and (RVe.codCarSum <= 'C50') then
    begin
...
procedure ActualizarArch(var archHis:   TArchHis; var archVer:   TArchVer; var archRes:TArchRes; vecST3:TVST3);
var
    RVe:TRegVer;
    RRe:TRegRes;
    RHi:TRegHis;
...
begin
    ...
    WriteLn('Promedio de Importe Total por cliente:   $', acumImporteTotal/cantClientes:0:2);
    WriteLn('Monto total en reservas hechas y NO usadas en el 2021: ', montoTotalReservasNoUsadas:0:2);
...
begin
    ...
    ActualizarArch(archHis,archVer,archRes,vecST3);
end.